...
def coco_mAP(param_sequence, n_classes, use_heatmap=True):
    """
    ...
    coco_gt_dict, coco_det_list = generate_coco_ground_truth_and_detections(param_sequence, n_classes, use_heatmap)
